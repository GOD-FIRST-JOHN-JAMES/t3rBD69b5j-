...
4.4.2	Licensor expressly waives rights to enforce, and grants permission to circumvent, technological protection measures
...
4.0	2013 Nov 25	
Initial announcement: Copyright Experts Discuss CC License Version 4.0 at the Global Summit
Beginning of public discussion: Version 4.0 – Public Discussion Launches
Draft 1: Version 4.0 – License Draft Ready for Public Comment!
Draft 2: Draft 2 of 4.0 Ready for Public Comment
Draft 3: 4.0 draft 3 published – final comment period underway
Draft 4: 4.0 draft 4 ready for comment — final consultation before publication
CC’s Next Generation Licenses — Welcome Version 4.0!	
What's New in 4.0: Summary
Policy decisions and versioning notes
Creative Commons Version 4.0 wiki pages
 Note that CC released a version 2.1 suite for jurisdictions like Spain, Australia, and Japan, whose localized ports of the 2.0 suite contained errors.
...
BY-NC-SA
BY-ND
BY-ND-NC (Note that in the 1.0 license suite, the name of this license is different than later versions)
Category: Legal
Navigation menu
